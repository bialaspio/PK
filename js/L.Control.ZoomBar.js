...
L.Control.ZoomBar = L.Control.extend(
{
    ...
    onAdd: function(map)
    {
        ...
        this._zoomStartButton  = this._createButton('', 'Mapa startowa',
                'leaflet-control-zoom-to-start',  container, this._zoomStart,  this);
                
        this._zoomInButton  = this._createButton('+', 'Powiększ',
                'leaflet-control-zoom-in',  container, this._zoomIn,  this);
                
        this._zoomOutButton = this._createButton('-', 'Pomniejsz',
        ...
        if( this._isSmallScreen()===false ){
            this._zoomToAreaButton = this._createButton('', 'Powiększ zakresem', 
