 L.Control.SwitchScaleControl = L.Control.extend({
  options: {
    ...
    ratio: true,
    ratioPrefix: '1:',
    ratioCustomItemText: '1: Wpisz wartość',
    customScaleTitle: 'Wpisz wartość',
    ratioMenu: true,
    ...
    scales: [500, 1000, 2000, 5000, 10000, 25000, 50000, 100000, 200000, 500000, 1000000],
    roundScales: null,
    adjustScales: false,
  ...
  onAdd: function (map) {
    ...
    container.setAttribute('title','Ustaw skale mapy');
